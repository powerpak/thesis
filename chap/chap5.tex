...
\sidequote{\smallcaps{John Anderton}, \emph{Minority Report}}{
...
\sidequote{\emph{Star Wars: Ep. V – The Empire Strikes Back}}{
  \speaker{C-3PO:} Sir, the possibility of successfully navigating an asteroid field is approximately 3,720 to one.
  
  \speaker{Han Solo:} Never tell me the odds!
}
...
\begin{table*}[ht]
  ...
  \captionfootnotetext{a}{Separate columns are unnecessary because 1:1 exact matching was performed on the characteristics shown, and therefore all values are identical.}
  \captionfootnotetext{b}{SMD is shown for age treated as a continuous variable; coarsened exact matching was performed using the listed age ranges.}
}
  \label{tab:cdi_pts}
\end{table*}
...
This work was supported by the Icahn Institute for Genomics and Multiscale Biology at Mount Sinai, and also in part by the NIH/NIAID grants F30-AI122673 (\smallcaps{TRP}), T32-GM007280 (\smallcaps{TRP}), and R01-AI119145 (\smallcaps{HVB}, \smallcaps{KC}). The content is solely the responsibility of the authors and does not necessarily represent the official views of NIH.
