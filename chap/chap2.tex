...
\label{chap:steno}
\emergencystretch=0pt % This chapter doesn't respond well to the stretching fix to hboxes, so we turn it off.

\hyphenation{Ste-no-tro-pho-mo-nas cip-ro-flox-a-cin}

\sidequote{\smallcaps{obi-wan}, \emph{Star Wars: Ep. IV – A New Hope}}{
...
\begin{table*}[ht]
  \input{chap/tables/steno-isolates}
  ...
  \captionfootnotetext{a}{Time of collection was defined in days relative to the date of collecting the initial \emph{S. maltophilia} isolate in the case patient}
  \captionfootnotetext{b}{This is the change in levofloxacin susceptibility investigated in this study.}
  \captionfootnotetext{c}{Inconsistent results were obtained in replicate.}}
  \label{tab:steno_pts}
\end{table*}
...
\begin{table}[ht]
  \input{chap/tables/steno-epigenetic}
...
Theodore R. Pak (\smallcaps{TRP}), Deena R. Altman (\smallcaps{DRA}), Oliver Attie (\smallcaps{OA}), Robert Sebra (\smallcaps{RS}), Camille L. Hamula (\smallcaps{CLH}), Martha Lewis (\smallcaps{ML}), Gintaras Deikus, (\smallcaps{GD})
Leah C. Newman (\smallcaps{LCN}), Gang Fang (\smallcaps{GF}), Jonathan Hand (\smallcaps{JH}), Gopi Patel (\smallcaps{GP}), Fran Wallach (\smallcaps{FW}), Eric E. Schadt (\smallcaps{EES}), Shirish Huprikar (\smallcaps{SH}), Harm van Bakel (\smallcaps{HVB}), Andrew Kasarskis (\smallcaps{AK}), and Ali Bashir (\smallcaps{AB}) contributed to this chapter. 

\smallcaps{TRP}, \smallcaps{DRA}, \smallcaps{SH}, and \smallcaps{AK} designed the study. \smallcaps{DRA}, \smallcaps{GP}, \smallcaps{FW}, and \smallcaps{CLH} organized collection of the samples. \smallcaps{GD}, \smallcaps{LCN}, and \smallcaps{RS} prepared sequencing libraries and performed sequencing. \smallcaps{CLH} performed culturing and drug susceptibility testing. \smallcaps{ML} performed PCR for Sanger sequencing. \smallcaps{TRP}, \smallcaps{OA}, \smallcaps{RS}, \smallcaps{GF}, \smallcaps{HVB}, and \smallcaps{AB} performed data analysis. \smallcaps{EES}, \smallcaps{SH}, \smallcaps{FW}, and \smallcaps{AK} provided institutional support. \smallcaps{JH} wrote the first draft of the case report. \smallcaps{TRP} created all figures and wrote the first draft of this chapter. All contributors saw, revised, and approved the final manuscript. \smallcaps{TRP} is the first author on the accepted manuscript.

\subsection*{Funding}

Funding was provided by the Icahn Institute for Genomics and Multiscale Biology at Mount Sinai, and also in part by the NIAID-supported NRSA Institutional Research Training Grant (5T32-AI764713) for Global Health Research (\smallcaps{DRA}). The content is solely the responsibility of the authors and does not necessarily represent the official views of NIH.
...
\emergencystretch=\esfix % Reactivate emergency stretching